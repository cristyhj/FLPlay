...
ImmediateStore.prototype.memory = function () {
  return this.store.memory()
}
ImmediateStore.prototype.clearSelection = function (a, b) {
  this.store.clearSelection(a, b)
}
ImmediateStore.prototype.clearAll = function () {
  this.store.clearSelection()
}
ImmediateStore.prototype.getPiecesString = function () {
  return this.store.getPiecesString()
}
ImmediateStore.prototype.getLastGetIndex = function () {
  return this.store.getLastGetIndex()
}
